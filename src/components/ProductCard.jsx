...
const products = [
  { name: "Product 1", price: "$49.99",  colors: ["#3498db", "#e74c3c", "#2ecc71"] },
  { name: "Product 2", price: "$39.99",  colors: ["#f1c40f", "#8e44ad", "#2c3e50"] },
  { name: "Product 3", price: "$29.99",  colors: ["#16a085", "#d35400", "#7f8c8d"] },
  { name: "Product 4", price: "$19.99",  colors: ["#2980b9", "#c0392b", "#27ae60"] },
  { name: "Product 5", price: "$59.99",  colors: ["#9b59b6", "#f39c12", "#34495e"] },
  { name: "Product 6", price: "$34.99",  colors: ["#1abc9c", "#e67e22", "#95a5a6"] },
  { name: "Product 7", price: "$44.99",  colors: ["#d35400", "#c0392b", "#bdc3c7"] },
  { name: "Product 8", price: "$54.99",  colors: ["#27ae60", "#8e44ad", "#f1c40f"] },
];
