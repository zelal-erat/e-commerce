...
export default function ShopPage() {
    ...
    return (
        ...
        <div className="flex flex-col items-center  gap-2 lg:flex-row  lg:justify-between lg:w-full lg:px-16">
      {items.map((item) => (
        <div
          key={item.id}
          className="relative w-64 h-80  flex items-center justify-center text-white text-lg font-bold uppercase"
        >
          <img src={item.image} alt="Clothing" className="absolute inset-0 w-full h-full object-cover " />
          <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center lg:w-[200px] lg:h-[200px]">
